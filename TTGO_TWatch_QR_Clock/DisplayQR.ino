void informationBits()
{
   ...
   for(int i = 210; i > 140; i-=10){
      if(TypeInfomationBits[counter] == 1){
        ttgo->tft->fillRect(i,170-Yoffset,10,10,TFT_BLACK);
      }else{
        ttgo->tft->fillRect(i,170-Yoffset,10,10,TFT_WHITE);
      } 
     counter += 1;
   }
   ...
   for(int i = 120; i > 40; i-=10){
     if(TypeInfomationBits[counter] == 1){
       ttgo->tft->fillRect(90,i-Yoffset,10,10,TFT_BLACK);
     }else{
       ttgo->tft->fillRect(90,i-Yoffset,10,10,TFT_WHITE);
     }
     counter += 1;  
   }
   ...
   if(TypeInfomationBits[counter] == 1){
     ttgo->tft->fillRect(90,180-Yoffset,10,10,TFT_BLACK);
   }else{
     ttgo->tft->fillRect(90,180-Yoffset,10,10,TFT_WHITE);
   }
   counter += 1; 
   
    if(TypeInfomationBits[counter] == 1){
     ttgo->tft->fillRect(90,170-Yoffset,10,10,TFT_BLACK);
   }else{
     ttgo->tft->fillRect(90,170-Yoffset,10,10,TFT_WHITE);
   }
   counter += 1; 
   
  if(TypeInfomationBits[counter] == 1){
     ttgo->tft->fillRect(80,170-Yoffset,10,10,TFT_BLACK);
   }else{
     ttgo->tft->fillRect(80,170-Yoffset,10,10,TFT_WHITE);
   }
   counter += 1; 
      ...
      int mask = (y + x) % 2;
        if(mask == 0){
          if(BinaryMessage[counter] == 1){
            //Do oposite
            ttgo->tft->fillRect(xPos,yPos-Yoffset,10,10,TFT_WHITE);
          } 
          if(BinaryMessage[counter] == 0){
            //Do oposite
            ttgo->tft->fillRect(xPos,yPos-Yoffset,10,10,TFT_BLACK);
          }
        }else if(mask == 1){
          if(BinaryMessage[counter] == 1){
            //Do oposite
